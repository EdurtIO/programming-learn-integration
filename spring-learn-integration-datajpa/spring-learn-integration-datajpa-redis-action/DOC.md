...
```bash
java -jar spring-learn-integration-datajpa/spring-learn-integration-datajpa-redis-action/target/spring-learn-integration-datajpa-redis-action-1.0.0.jar
```
...
- [GitHub](https://github.com/qianmoQ/spring-learn-integration/tree/master/spring-learn-integration-datajpa/spring-learn-integration-datajpa-redis-action)
- [Gitee](https://gitee.com/qianmoQ/spring-learn-integration/tree/master/spring-learn-integration-datajpa/spring-learn-integration-datajpa-redis-action)
